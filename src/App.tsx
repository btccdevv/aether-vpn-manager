...
function App() {
  const [vpnPath, setVpnPath] = useState<string | null>(null);
  ...
  return (
    <div className="h-screen w-screen bg-[#09090b] text-white overflow-hidden flex flex-col relative font-sans">
      ...
      <SeasonalOverlay theme={settings.theme} />
      ...
      <div className="flex-1 flex z-10 relative min-h-0">
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden">
          <AnimatePresence mode='wait'>
            ...
            {view === 'settings' && <motion.div key="settings" className="h-full z-20"><SettingsView settings={settings} setSettings={setSettings} vpnPath={vpnPath} setVpnPath={saveSetupPath} appVersion="5.0 God Mode" /></motion.div>}
          </AnimatePresence>
        </div>
      </div>
    </div>
